...
# _clean       intermediate variable - clean part of NA split ;-}
# _dirty       intermediate variable - NA part of NA split ;-}
...
# sta_NA_ora <- sta_ge71m05 %>%
#  filter(is.na(ora)) # check is :-]
...
# sta_NA_oel <- sta_ge71m05 %>%
#   filter(is.na(ora)) # check is :-]
# rm(sta_NA_oel)

#   4. fix Oelrichs & Oral NA with Harrision
#     Before: 10 concurrent NA values 
...
sta_ge71m05 <- sta_ge71m05 %>%
  select(-prcp, -id) 
sta_int_1 <- bind_rows(sta_ge71m05, sta_lt71m05)

# Check work
# introduce(sta_raw)
#   rows columns  total_missing_values total_observations
# 45592      9           102763             410328 

# introduce(sta_int_1)
#   rows columns  total_missing_values total_observations
# 45592       9          101926             410328
