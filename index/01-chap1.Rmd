...
sta_int   <- import("data/sta_int.csv")
...
# sta          precipitation station
# _meta        metadata
# _trans        the "mostly" raw dataset
# _geXX        data greater than or equal to year XX
# _geXXmYY     data greater than or equal to year XX and month YY 
# _ltXXmYY     data less than year XX and month YY 
# _clean       intermediate df - clean part of NA split ;-}
# _dirty       intermediate df - NA part of NA split ;-}
# _int_Z       df - number increases after each cleaning

# NAs are caused in part by different start dates
# ORAL        1971 - 2018  -fixed
...
sta_ge51m08 <- bind_rows(sta_clean, sta_dirty)
  rm(sta_clean, sta_dirty, sta_int)
  
sta_NA <- sta_ge51m08 %>%
   filter(is.na(mis)) # check is :-]
 rm(sta_NA)
...
introduce(sta_trans2)
#  rows columns  total_missing_values total_observations
# 45592       9           101068            410328
...
# NAs are caused in part by different start dates
# ORAL        1971 - 2018  -fixed
# MISSION     1951 - 2018  -fixed
# INTERIOR    1949 - 2018  -in.progress   
# RAPID CITY  1948 - 2018    
# COTTONWOOD  1909 - 2018        
# OELRICHS    1893 - 2018   
...
#     Before = 613 NA <- filling with Cottonwood
#     After: 3 NA values 
...
sta_NA <- sta_ge49m11 %>%
   filter(is.na(int)) # check is :-]
 rm(sta_NA)

#   5. Put the pieces back together
sta_ge49m11 <- sta_ge49m11 %>%
  select(-prcp, -id) 
...
introduce(sta_trans3)
#   rows columns total_missing_values total_observations
# 45592       9           100455            410328         
 
# export the work to a file
export(sta_trans3, file = "data/stations_trans2.csv")  
```
...
# ORAL        1971 - 2018  -fixed
# MISSION     1951 - 2018  -fixed
# INTERIOR    1949 - 2018  -fixed  
# RAPID CITY  1948 - 2018  -in.progress 
# COTTONWOOD  1909 - 2018        
# OELRICHS    1893 - 2018   
...
#     Before: 850 NA <- filling with Cottonwood
...
sta_NA <- sta_ge49m11 %>%
  filter(is.na(cot)) # check is :-] # down to 3 vals
  rm(sta_NA)
