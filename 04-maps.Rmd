...
# import location data and filter out:
#   hermosa, ainsworth, harrison, hot springs
sta_meta <- import("index/data/station_meta2.csv")
sta_meta <- sta_meta %>%
  ...
  filter(id != "GHCND:US1SDJK0006") %>% # too short - KAD
...
# One idea - kadoka is short but might be added to long valley, but
# its easier to just use a single complete record from further away.
