...
2.0  Data read in from NOAA website
3.0  Data munging to check, join and remove NAs
3.1  Updated unit vals - originally in tenths of mm; now in mm
3.2  Changed daily data into monthly and annual data
3.3  Cross-validated monthly data
3.4  Created plots
4.0  Describe results:
...
# load metadata 
sta_meta <- import("~/Google Drive/eco_drought/index/data/sta_meta_orig.csv")
...
```{r  monthly_summaries, eval = FALSE}
